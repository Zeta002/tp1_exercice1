...
public class Fantome extends Personnage {
    ...
    public void deplacerAGauche() {
        ...
        retineDroite.setCenterX(oeilDroit.getCenterX() + .3);
        retineGauche.setCenterX(oeilGauche.getCenterX() + .3);
    ...
    public void deplacerEnBas(double hauteurJeu) {
        ...
        retineDroite.setCenterY(oeilDroit.getCenterY() - .5);
        retineGauche.setCenterY(oeilGauche.getCenterY() - .5);
